    ...
    <main class="legal-content">
        <section class="legal-section">
            ...
            <article>
                ...
                <p>Ces informations sont recueillies uniquement lors de l'utilisation du formulaire de contact.</p>
            </article>
            ...
            <article>
                ...
                <p>Nous mettons en place des mesures de sécurité appropriées pour protéger vos informations personnelles contre tout accès, modification, divulgation ou destruction non autorisée.</p>
            </article>

            <article>
                <h2>4. Cookies</h2>
                <p>Notre site utilise des cookies pour améliorer votre expérience de navigation. Les cookies sont de petits fichiers stockés sur votre appareil qui nous aident à :</p>
                <ul>
            ...
            <article>
                ...
                <p>Email : dev2ls13820@gmail.com<br>
                Téléphone : 06.82.49.51.32</p>
            </article>

            <article>
                <h2>7. Modifications</h2>
                <p>Nous nous réservons le droit de modifier cette politique de confidentialité à tout moment. Les modifications prendront effet dès leur publication sur ce site.</p>
            </article>
        </section>
    </main>
